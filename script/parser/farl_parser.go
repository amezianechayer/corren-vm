...
const (
	...
	FaRlParserCALC       = 2
	FaRlParserFAIL       = 3
	FaRlParserIDENTIFIER = 4
	FaRlParserASSET      = 5
	FaRlParserNUMBER     = 6
	FaRlParserOP_ADD     = 7
	FaRlParserOP_SUB     = 8
	FaRlParserSEP        = 9
	FaRlParserWHITESPACE = 10
)

// FaRlParser rules.
const (
	FaRlParserRULE_expression = 0
	FaRlParserRULE_statement  = 1
	FaRlParserRULE_script     = 2
)
...
func (p *FaRlParser) expression(_p int) (localctx IExpressionContext) {
	...
	_startState := 0
	p.EnterRecursionRule(localctx, 0, FaRlParserRULE_expression, _p)
	var _la int
...
func (s *CalcContext) CALC() antlr.TerminalNode {
	return s.GetToken(FaRlParserCALC, 0)
}
...
func (p *FaRlParser) Statement() (localctx IStatementContext) {
	...
	p.EnterRule(localctx, 2, FaRlParserRULE_statement)
...
func (p *FaRlParser) Script() (localctx IScriptContext) {
	...
	p.EnterRule(localctx, 4, FaRlParserRULE_script)
	var _la int
	...
	if _la == FaRlParserCALC || _la == FaRlParserFAIL {
		{
			p.SetState(30)
			p.Statement()
		}
